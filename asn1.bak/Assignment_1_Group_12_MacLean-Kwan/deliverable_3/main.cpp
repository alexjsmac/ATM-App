        ...
        Customer userAccount = man.findCust(loginID); //If the customer exists, we load the customer object
            ...
            cust: //Customer option menu
                ...
                switch(choice)
                {
                    ...
                    transfer: //Customer chooses to transfer money
                        ...
                        switch(account){
                            case 1:{ //Transfer from checking to savings account
                                ...
                                double checkBalance = userAccount.getBalance(0) - amount; //Calculating new checking account balance
                                double saveBalance = userAccount.getBalance(1) + amount; //Calculating new savings account balance
                            ...
                            case 2:{
                                ...
                                // Check for possible negative balance
                                if (saveBalance < 0) {
                    ...
                    case 5:{
                        cout<<"What kind of an account would you like to open?\n";
                        cout<<"1)   Chequing Account\n";
                        cout<<"2)   Savings Account\n";
                        int choice;
                        cin>>choice;
                        ...
                        if (choice == 1) {
                            userAccount.openAccount(0);
                        }
                        else if (choice == 2){
                            userAccount.openAccount(1);
                        }
                        
                        break;
                    }
                    case 6:{
                        cout<<"Which account would you like to close?\n";
                        cout<<"1)   Chequing Account\n";
                        cout<<"2)   Savings Account\n";
                        int choice;
                        cin>>choice;
                        ...
                        if (choice == 1) {
                            userAccount.closeAccount(0);
                        }
                        else if (choice == 2){
                            userAccount.closeAccount(1);
                        }
